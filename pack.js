...
const BUILDS = [
  { src: 'chess.js',   out: 'index.html',   head: '<center><table id=T style=zoom:3><script>', crush: [0.5, 0, 0.25, -1] },
  { src: 'minimal.js', out: 'minimal.html', head: '<input id=p><table id=T><script>',          crush: [0.5, 1, 0, -1] },
  { src: 'Lowest.js',  out: 'Lowest.html',  head: '<script>',                                  crush: [0.5, 1, 0, -1] },
];
